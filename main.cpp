...
void main_loop()
{
    ...
    ImGui::Begin("Synacor VM", &im_mainWindow, window_flags);
    ...
    // === Register
    ImGui::SetNextWindowSize(ImVec2(250, 270), ImGuiSetCond_FirstUseEver);
    ...
    ImGui::Begin("Stack Editor", &im_openStackEditor, window_flags);
    ...
    ImGui::Begin("Memory Editor", &im_openMemoryEditor, window_flags);
